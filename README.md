...
You can modify the LLM model in the code (default: gemini-2.5-flash):
...
- Gemini API: depends on selected Gemini model
...
4. Review CrewAI and Google Gemini documentation
